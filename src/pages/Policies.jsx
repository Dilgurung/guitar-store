      ...
      <main className="policies-main-content">
        ...
        <section className="shipping-policy">
          ...
          <p>
            ...
            , we take pride in ensuring that our guitars reach you safe and fast.
            ...
            within Nepal  and internationally. Shipping costs are calculated
        ...
        <section className="return-policy">
          ...
          <p>
            ...
            satisfied with your purchase, you may return it within 10 days of
            receipt for a full refund or exchange in some of the products. The items must be returned in
            their original condition . Please note that return
            shipping costs are not covered by Guitar Store.
          </p>
        </section>
        ...
        <section className="terms-conditions">
          ...
          <p>
            By accessing or using Guitar store website and our services, you
        ...
        <section className="sustainability-commitment">
          ...
          <p>
          Sustainability is at the heart of everything we do at Guitar store.we are dedicated to promoting environmentally friendly practices,supporting local communities,and ensuring the highest standards of ethical sourcing.Learn more about our initiatives and how we strive to make a positive impact on the environment and society.
          </p>
        </section>
      </main>
